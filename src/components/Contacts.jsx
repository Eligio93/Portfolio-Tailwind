...
import contactAstronaut from "/contactAstronaut.png";

export default function Contacts() {
  return (
    <div className="flex min-h-screen flex-col gap-5 rounded-lg p-3 text-white md:p-5">
      <Header />
      <div className="flex flex-1 flex-col items-center gap-5">
        ...
        <img
          className="max-h-[200px] object-contain lg:max-h-[300px]"
          src={contactAstronaut}
          alt=""
        />
        <div className="flex w-full flex-col items-center gap-10 lg:flex-row lg:justify-evenly">
          {/*githubLink*/}
          <a
          ...
          >
            ...
            >
              <circle
                className="fill-sky-500 transition-colors group-hover:fill-pink-500"
                cx="24"
                cy="24"
                r="20"
              />
            ...
            <p className="text-xl font-bold text-sky-500 transition-colors hover:underline group-hover:text-pink-500">
              Github
            </p>
          </a>
          {/*email link*/}
          ...
          >
            <svg
              className="h-12 w-12 fill-sky-500 transition-colors group-hover:fill-pink-500 lg:h-24 lg:w-24"
              viewBox="0 0 100 100"
            >
              <g>
                <path
		...
		L50.431,53.202L14.326,26H86.047z"
          ...
          >
            <svg className="h-12 w-12 lg:h-24 lg:w-24" viewBox="0 0 48 48">
              <circle
                className="fill-sky-500 transition-colors group-hover:fill-pink-500"
                cx="24"
                cy="24"
